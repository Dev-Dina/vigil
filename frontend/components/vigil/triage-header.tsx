...
interface TriageHeaderProps {
  // Optional trial selector — rendered ONLY when real trials are supplied. The cohort is otherwise
  // the caller's full scoped cohort (no client-supplied trial filter).
  trials?: Trial[]
